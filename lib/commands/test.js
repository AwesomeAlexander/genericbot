...
exports.default = new exports_1.Command("test", // The name of the command, and how it is called by users.
"Test command", // Description of what the command does, used in command help.
whenCalled, // Function (defined above) that runs when the command is run.
['SUPERUSER'], // Permissions needed to run the command.
